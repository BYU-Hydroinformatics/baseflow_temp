...
project = 'CIROH Baseflow Python Library'
copyright = '2024, BYU Hydroinformatics Laboratory'
author = 'CIROH-GW Research Assistants'
...
#html_static_path = ['_static']
#html_logo = '_static/baseflowlogo.png'
master_doc = 'index'
